// @generated by protoc-gen-es v2.10.2 with parameter "target=ts,ts_nocheck=true"
...
export type UserMessage = Message<"agent.v1.UserMessage"> & {
  ...
  /**
   * Local compatibility declaration retained from this provider's previous binding.
   *
